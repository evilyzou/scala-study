...
XLJ.forDight = window.XLJ.forDight || function(dight, how) {
    how = how || 0
...
//     return NumberAccMul(arg, this);
// }
//
//
// //加法函数，用来得到精确的加法结果
// //说明：javascript的加法 结果会有误差，在两个浮点数相加的时候会比较明显。这个函数返回较为精确的加法结果。
// //调用：NumberAccAdd(arg1,arg2)
// // 返回值：arg1加上arg2的精确结果
// function NumberAccAdd(arg1, arg2) {
//     var r1, r2, m;
//     try {
