...
Formatter = (function(superClass) {
  ...
  Formatter.prototype.cleanNode = function(node, recursive) {
    ...
    if ($node.is(this._allowedTags.join(',')) || isDecoration) {
      ...
      // don't remove the <a><img/></a> // 2016-04-13 by zihan
...
LinkButton = (function(superClass) {
  ...
  LinkButton.prototype.command = function() {
    ...
    if (this.active) {
      ...
      linkText = $contents.contents();  // don't clear the img node in order to mark img link -- modify on 2016-04-15 by zihan
      //linkText = this.editor.formatter.clearHtml($contents.contents(), false);
      $link = $('<a/>', {
        href: 'http://www.example.com',
        target: '_blank',
        html: linkText || this._t('linkText') // modify on 2016-04-15 by zihan
  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    this.editor.uploader.on('uploadsuccess', (function(_this) {
      return function(e, file, result) {
        ...
        result.file_path = result.result.imgDomain + '/' + result.result.url    // custome img path 2015-11-04 by zihan
