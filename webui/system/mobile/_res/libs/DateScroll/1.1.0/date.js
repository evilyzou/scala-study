...
//            }
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {
                ...
                var dateNum = $("#daywrapper ul li:eq("+Math.round(indexD)+")").html().substr(0,$("#daywrapper ul li:eq("+Math.round(indexD)+")").html().length-1);
                datestr += ((dateNum < 10) ? '0' + dateNum : dateNum);

                if (datetime) {
//                    if(Math.round(indexS)===1){
//                        $("#Hourwrapper ul li:eq("+indexH+")").html(parseInt($("#Hourwrapper ul li:eq("+indexH+")").html().substr(0,$("#Hourwrapper ul li:eq("+indexH+")").html().length-1))+12 + ":00")
//                    } else {
//                        $("#Hourwrapper ul li:eq("+indexH+")").html("0" + parseInt($("#Hourwrapper ul li:eq("+indexH+")").html().substr(0,$("#Hourwrapper ul li:eq("+indexH+")").html().length-1)) + ":00")
//                    }

                    var indexH_num = parseInt($("#Hourwrapper ul li:eq("+indexH+")").html().substr(0,$("#Hourwrapper ul li:eq("+indexH+")").html().length-1));
//                    if (indexH_num < 10) {
//                        $("#Hourwrapper ul li:eq("+indexH+")").html("0" + indexH_num + ":00");
//                    } else {
//                        $("#Hourwrapper ul li:eq("+indexH+")").html(indexH_num + ":00");
//                    }
                    $("#Hourwrapper ul li:eq("+indexH+")").html(indexH_num);

                    var hourNum = $("#Hourwrapper ul li:eq("+indexH+")").html().substr(0,$("#Minutewrapper ul li:eq("+indexH+")").html().length-1);
                    datestr += " "+ ((hourNum < 10) ? '0' + hourNum : hourNum) +":"+
        ...
        function init_iScrll() { 
            var sss = $("#yearwrapper ul li:eq("+indexY+")").html();
