...
import java.io.{StringReader, Reader, ByteArrayInputStream, InputStream}
...
class RowDataResultSet(var currentRow: Option[RowData], var other: Iterable[RowData]) extends ResultSet {
